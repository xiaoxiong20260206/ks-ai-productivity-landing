...
const STAR_MASSIVE = {
  ...
  phases: [
    ...
    },
    {
      key: "ultramassive-wd",
      name: "超大质量白矮星",
      ageStartMyr: 9700, ageEndMyr: 380000,
      spanLabel: "97 亿年之后",
      state: "接近钱德拉塞卡极限",
      ...
      teach: {
        emoji: "💎",
        title: "终章：宇宙中最危险的白矮星",
        caption: "它的质量约为 1.3 个太阳，仅比「1.4 M☉ 的钱德拉塞卡极限」低一点点。这颗白矮星非常不稳定——如果它从伴星吸收一点点额外的质量，随时可能触发 Ia 型超新星爆炸！这是宇宙中最危险的天体之一。天文学家把这类白矮星叫做「定时炸弹」。"
      }
    }
  ],
  endingTitle: "终章：超级AGB → 超大质量白矮星",
  endingDesc: "没有超新星！8 M☉ 站在临界线上，核心最终留下约 1.3 M☉ 的超大质量白矮星，仅比中子星诞生阈值低一点。宇宙中的「定时炸弹」。",
  endingBadge: "💎 超大质量白矮星",
  endingNote: "💡 科学小知识：白矮星质量上限约 1.4 M☉（钱德拉塞卡极限）。这颗白矮星质量约 1.3 M☉，极其接近极限——若从伴星吸到微量物质，可能引爆 Ia 型超新星，比 II 型超新星还要亮！",
  quiz: [
