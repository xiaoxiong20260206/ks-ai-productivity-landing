...
const STAR_SUN = {
  ...
  phases: [
    ...
    },
    {
      key: "white-dwarf",
      name: "白矮星",
      ageStartMyr: 11500, ageEndMyr: 380000,
      spanLabel: "115 亿年以后",
      state: "碳氧白矮星冷却",
      lumLsun: 0.0005, tempK: 12000, radiusRsun: 0.012,
      color: "#c8d8ff", halo: "rgba(180,210,255,0.25)",
      note: "外层抛尽后，剩余的碳氧核心成为白矮星，体积如地球，靠余热发光。",
      teach: {
        emoji: "💙",
        title: "白矮星：太阳的遗骸",
        caption: "星云散去后，太阳的核心留下来，变成了白矮星——大约地球大小，但密度超高。它会缓慢冷却几十亿年，最终变成黑矮星……如果宇宙足够老的话。"
      }
    }
  ],
  endingTitle: "终章：行星状星云 → 白矮星",
  endingDesc: "太阳会先变成红巨星，吞噬地球，再华丽地抛出星云，剩下白矮星缓缓冷却。",
  endingBadge: "💙 白矮星",
  quiz: [
...
const STAR_MASSIVE = {
  ...
  endingTitle: "终章：超新星爆炸 → 中子星",
  endingDesc: "壮烈的死亡！铁核坍缩在1秒内，冲击波以光速10%的速度炸开，诞生中子星。",
  endingBadge: "💥 中子星",
  quiz: [
    { q: "超新星爆炸有多亮？", a: "爆炸峰值时比整个银河系还亮！可以在白天肉眼看到，持续数周。", ok: true, icon: "💥" },
    { q: "中子星有多小？", a: "直径只有约12公里——但质量约是太阳的1.5倍！每茶匙重达 10 亿吨。", ok: true, icon: "📡" },
    { q: "我们身体里的铁元素来自哪里？", a: "来自超新星爆炸！超新星是宇宙中合成铁等重元素的工厂，然后散播到宇宙中。", ok: true, icon: "⭐" }
  ]
};
